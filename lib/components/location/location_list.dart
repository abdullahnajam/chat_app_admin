                            ...
                            InkWell(
                              onTap: ()async{
                                if (_formKey.currentState!.validate()){
                                  ...
                                  await FirebaseFirestore.instance.collection('location').doc(model.id).update({
    ...
    return Container(
      ...
      child: SizedBox(
          ...
          child:StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection('location').orderBy('createdAt',descending: true).snapshots(),
          ...
          DataCell(
            Row(
              children: [
                ...
                IconButton(
                  onPressed: ()async{
                    await FirebaseFirestore.instance.collection('location').doc(model.id).delete().then((value) {
                      print("deleted");
                    }).onError((error, stackTrace){
