    ...
    return Container(
      ...
      child: Column(
        children: [
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      items: ['Main Group Code','Sub Group 1 Code','Sub Group 2 Code','Sub Group 3 Code','Sub Group 4'].map<DropdownMenuItem<String>>((String value) {
          ...
          Expanded(
            child: FutureBuilder<List<SubGroup4Model>>(
                future: FirebaseApi.getAllSubgroup4Filtered(filter,query),
                builder: (context, AsyncSnapshot<List<SubGroup4Model>> snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    return Center(
                        child: CircularProgressIndicator()
                    );
                    ...
                    if (snapshot.hasError) {
                      ...
                      return DataTable2(
                          ...
                          columns: const [
                            ...
                            DataColumn(
                              label: Text("Sub Group 3 Code/Name"),
                            ),
                            DataColumn(
                              label: Text("Sub Group 4 Name"),
                            ),
                          ...
                          rows:  List<DataRow>.generate(snapshot.data!.length, (index){
                            return DataRow(
                                cells: [
                                  ...
                                  DataCell( FutureBuilder<SubGroup3Model?>(
                                      future: FirebaseApi.getSubGroup3Model(snapshot.data![index].subGroup3Code),
                                      builder: (context, AsyncSnapshot<SubGroup3Model?> usersnap) {
                                        if (usersnap.connectionState == ConnectionState.waiting) {
                                          return Center(
                                            child: CupertinoActivityIndicator(),
                                          );
                                          ...
                                          if (usersnap.hasError) {
                                            ...
                                            if(usersnap.data==null){
                                              return Text('${snapshot.data![index].subGroup3Code}/ N/A');
                                            }
                                            else{
                                              return Text('${snapshot.data![index].subGroup3Code}/${usersnap.data!.name}');
