...
import 'job_description_list.dart';
class JobDescription extends StatefulWidget {

  GlobalKey<ScaffoldState> _scaffoldKey;

  JobDescription(this._scaffoldKey);
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Text("ADD JOB DESCRIPTION",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: Colors.white),),
                              ),
                            ),
                            Align(
                            ...
                            InkWell(
                              onTap: ()async{
                                if (_formKey.currentState!.validate()){
                                  ...
                                  int count=0;
                                  await FirebaseFirestore.instance.collection('job_description')
                                  ...
                                  await FirebaseFirestore.instance.collection('job_description').add({
                              ...
                              child: Container(
                                ...
                                alignment: Alignment.center,
                                child: Text("Add Job Description",style: Theme.of(context).textTheme.button!.apply(color: Colors.white),),
                              ),
                            )
                          ],
                        ),
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Header("Job Description",widget._scaffoldKey),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(
                            ...
                            icon: Icon(Icons.add),
                            label: Text("Add Job Description"),
                          ),
                        ],
                      ),
