...
class OccupationList extends StatefulWidget {
  const OccupationList({Key? key}) : super(key: key);
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Text("EDIT OCCUPATIONS",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: Colors.white),),
                              ),
                            ),
                            Align(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                alignment: Alignment.center,
                                child: Text("Update Occupation",style: Theme.of(context).textTheme.button!.apply(color: Colors.white),),
                              ),
                            )
                          ],
                        ),
