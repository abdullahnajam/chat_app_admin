...
class ResponsibilityTypeList extends StatefulWidget {
  const ResponsibilityTypeList({Key? key}) : super(key: key);

  @override
  _ResponsibilityTypeListState createState() => _ResponsibilityTypeListState();
}
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Text("EDIT RESPONSIBILITY TYPE",textAlign: TextAlign.center,style: Theme.of(context).textTheme.headline5!.apply(color: Colors.white),),
                              ),
                            ),
                            Align(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                alignment: Alignment.center,
                                child: Text("Update Responsibility Type",style: Theme.of(context).textTheme.button!.apply(color: Colors.white),),
                              ),
                            )
                          ],
                        ),
